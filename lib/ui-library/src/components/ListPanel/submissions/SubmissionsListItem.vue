		...
		<div class="listPanel__itemSummary">
			<div class="listPanel__itemIdentity listPanel__itemIdentity--submission">
				<div class="listPanel__item--submission__id">
					<!-- Exibe ID do CSP ao invés de ID do OJS -->
					{{ item.publications[0].submissionIdCSP }}
				</div>
...
export default {
	...
	computed: {
		...
		notice() {
			...
			// Notices for authors
			// Permite que outros perfis vejam o status do autor
			if (this.userAssignedRole([
...
<style lang="less">
@import '../../../../../../../../../lib/ui-library/src/styles/variables.less';
